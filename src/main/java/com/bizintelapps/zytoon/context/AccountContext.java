 ...
 */
package com.bizintelapps.zytoon.context;
...
public class AccountContext {
    ...
    /**
     * Bind the passed username to the account Context thread. This username is not set on the {@link Users}.
     */
    ...
    public boolean hasRole(String roleName) {
        List<String> roles_ = getRoleNames();
    ...
    /**
     * Return the {@link Users} instance bound to the current thread, if any.
     *
    ...
    /**
     * Tell whether the passed account is the same as the {@link Users}
     * instance bound to the current thread, that is if their ids are equals.
     * It can be used for security purposes.
     *
     * @return true if the {@link Users} primary keys are equal, false otherwise.
     */
    public boolean isAccount(Users accountToCheck) {
