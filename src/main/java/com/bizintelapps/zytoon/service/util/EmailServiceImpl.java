...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendEmail(String[] to, String subject, String body) {
        sendSSMessage(to, subject, body + EMAIL_SIGNATURE);
    }
    ...
    @Override
    @Async
    public void sendWelcomeEmail(String[] recipients, String subject, String message) {
        sendSSMessage(recipients, subject, message);
    }
    ...
    private void sendSSMessage(String recipients[], String subject,
        ...
        try {
            ...
            send(createSession(), addressTo, subject, message);
    ...
    private void send(Session session, InternetAddress[] addressTo, String subject, String message) throws AddressException, MessagingException {
